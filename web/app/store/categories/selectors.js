...
export const getCategoryHref = createGetSelector(getSelectedCategory, 'href')
export const getCategoryPageMeta = createGetSelector(getSelectedCategory, 'pageMeta', Immutable.Map())
